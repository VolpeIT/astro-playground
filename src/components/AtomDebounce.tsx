...
export const AtomDebounce = () => {
  const [value1, handler1] = useUrlInputAtomDebounce(_1, "nombre", _l1);
  const [value2, handler2] = useUrlInputAtomDebounce(_2, "comida", _l2);
  const [value3, handler3] = useUrlInputAtomDebounce(_3, "edad", _l3);
